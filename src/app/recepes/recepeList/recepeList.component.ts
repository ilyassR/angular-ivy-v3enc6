...
export class RecepeListComponent {
  recepes: Recepe[] = [
    ...
    new Recepe('name2', 'description2', 'https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_12:9/k%2FPhoto%2FRecipes%2F2020-02-Kielbasa-and-Cabbage-Skillet%2Fkielbasa2')
  ];
